...
import portal.news.dto.apiException.ApiValidationExceptionResponseDto;
...
public class GlobalExceptionHandler {
    ...
    private final Map<Class<?>, String> errorMessage = new HashMap<>();
    ...
    public ApiExceptionResponseDto handleHttpMessageNotReadableException(
        ...
        String errorMessageOrDefault = errorMessage.getOrDefault(
    ...
    private void initializeExceptionMap() {
        errorMessage.put(DateTimeParseException.class, "Invalid date format, use ISO-8601");
    }
}
